...
#             image = Image.open(r"C:\Users\nikita.kathuria\Downloads\MicrosoftTeams-image (2).png") #read img
...
# # Upload manufacturing image
# image_path = r"C:\Users\nikita.kathuria\Downloads\MicrosoftTeams-image (2).png"
# image = Image.open(image_path) #read img

# input_data_1 = {
#     'Steam Inlet Temp': 100,
#     'Steam Outlet Temp': 110,
#     'Steam Sep Line Temp': 120,
#     'Transfer cool air temp': 25,
#     'Transfer Air': 30
# }

# predicted_moisture_content = np.random.rand() * 10  # Replace this with your actual prediction

# # Create a streamlit layout to show the text above the image
# st.header("Manufacturing Image with Text Overlay")
...
# styled_text = f"<span style='font-weight:bold;color:green'>Predicted LOD Content: {round(predicted_moisture_content, 2)}%</span>"
# st.markdown(styled_text, unsafe_allow_html=True)
...
if nav_option == PAGE_0:
    ...
    # Upload manufacturing image
    image = Image.open(r"solution_flow.jpeg") #read img
    # Display the image using streamlit's `image` function
    st.image(image, use_column_width=True)
